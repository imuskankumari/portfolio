...
function renderLightboxActiveContent() {
    ...
    if(currentAsset.type === 'video') {
        contentWrap.innerHTML = `<video id="lightboxVideoNode" src="${currentAsset.src}" controls autoplay style="width:100%; max-height:80vh; object-fit:contain; border-radius:12px;"></video><p class="lightbox-caption">${currentAsset.name}</p>`;
    } else {
